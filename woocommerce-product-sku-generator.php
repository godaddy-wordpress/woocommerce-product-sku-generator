...
class WC_SKU_Generator {
	...
	public function __construct() {
		...
		if ( is_admin() && ! defined( 'DOING_AJAX' ) ) {
			...
			add_action( 'woocommerce_product_bulk_edit_save', array( $this, 'get_maybe_save_sku' ) );
			add_action( 'woocommerce_process_product_meta', array( $this, 'get_maybe_save_sku' ), 100, 2 );
	 ...
	 */
	public function get_maybe_save_sku( $product ) {
